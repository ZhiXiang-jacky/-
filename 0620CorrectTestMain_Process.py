...
if __name__ =='__main__':
    ...
    for arg1 in range(nb_threads):
        ...
        for j in range(arg1, len(temp_Select_Fitness_Df1),nb_threads):
            ...
            t.append(multiprocessing.Process(target = Forward_Insertion_Method_Improved, args=(q1,q2,arg1,List_OrderNumber_Stime_Endtime[j],temp_Select_Fitness_Df1[j])))
    ...
    for arg1 in range(nb_threads):
        ...
        for j in range(arg1, len(temp_Select_Fitness_Df1), nb_threads):
            ...
            List_OrderNumber_Stime_Endtime[int(small_temp_List[-1][0])].insert(int(small_temp_List[-1][0]), small_temp_List)
    ...
    for i in range(len(List_OrderNumber_Stime_Endtime)):
        print(List_OrderNumber_Stime_Endtime[i][-1][-1][0])
